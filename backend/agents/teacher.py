...
class TeacherAgent:
    ...
    def writer(self, query: str, sources: list):
        ...
        prompt = [{
            "role": "system",
            "content": "You are a questionaire writer for a quiz. Your sole purpose is to form a well-written question with one word answer about a "
            ...
            "content": f"Today's date is {datetime.now().strftime('%d/%m/%Y')}\n."
                       ...
                       f"{sources}\n"
                       f"Your task is to write a welformed question for the test takers about the provided query or "
    ...
    def revise(self, article: dict):
        prompt = [{
            "role": "system",
            "content": "You are a question paper editor. Your sole purpose is to edit a well-written question about a "
